...
category: blog
author: Naveen
description: This blog post recounts a scenario of account takeover where user accounts were compromised through response manipulation during the login process.
---
